    ...
    <div data-role="content">
        ...
        <div class="ui-grid-a" id="videolist">
            ...
            foreach ($menu as $key=>$value){
                echo '
                <div class="ui-block-'.$letra.'">
                <a href="#cat'.$value["catid"].'"  data-role="button" data-icon="arrow-r">
                <div>'.utf8_encode($value["cat_name"]).' <span class="small-txt">'.utf8_encode($value["cat_details"]).'</span> </div>
...
<div id="contacto" data-role="page" data-title="Contacta" data-theme="b" ><!-- Page: contacto -->
    ...
    <div data-role="content">
        ...
        <input type="text" name="nombre" id="username" value="" placeholder="Nomnbre" data-mini="true"/>
        <label for="username">Asunto:</label>
        <input type="text" name="asunto" id="username" value="" placeholder="Asunto" data-mini="true" />
