...
//Variables de sesi�n con los datos de  la factura ,fecha y n�mero
if ($_POST['fecha'] )
...
//Si hemos rellenado los datos del clientes creamos la sesi�n cliente
if ($_POST['cliente'] )
{
if ($_POST['rsocial'] )
...
<table border="1" width="80%" align="left">    
  <tr>
  <td>
  <?php echo "Página ".$pagina; ?>   </td>
  
      <td> Fecha:
<?php echo $_SESSION['factura']['fecha'] ?>          </td>
          <td>
          Número de factura: <?php echo $_SESSION['factura']['num_fact'] ?>          </td>
</td>
</tr>
</table>
<p>&nbsp;</p>
...
if ($_POST['discount']==-1)
 ...
 $j=0; //contador para paginar resultado
    ...
    <td  class='items' align="center"><?php echo $_SESSION['pedidos'][$i][3] ?> €</td>
...
<table width="100%" border="0" align="right">
  ...
  <td align="center" class="enunciados"> Forma de pago:  <?php echo  $_SESSION['forma_pago'] ?>   </td>
   <td align="center" class='items' width="20%" >Suma: <?php echo $_SESSION['suma_total'] ?> € </td>
  </tr>
  	<tr>
        <td> </td>

	<td align="center" class='items'>
	Portes:</h5> <?php echo $_SESSION['portes'] ?> €	</td>
	</tr>
    <?php
	...
	Descuento:</h5> <?php echo $_SESSION['discount']; ?> €	</td>
	<?
	}
	?>
    	<tr>
...
<table width="100%" border="1" cellpadding="8" cellspacing="8">
  ...
  <tr>
	...
	&amp;pagina=<? echo $pagina ?>">Imprimir página: <? echo $pagina ?></a></td>
  ...
  <tr>
    <td height="115" colspan="7" class="anadir_cesta"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <form id="form2" name="form1" method="post" action="">
          ...
          <tr>
            <td width="45%"><div align="right">Razón social </div></td>
            <td width="55%"><label>
          ...
          <tr>
            <td><div align="right">Móvil</div></td>
            <td><div align="left">
