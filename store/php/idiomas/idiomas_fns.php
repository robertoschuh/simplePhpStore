...
$user['country']=array();
//Cabecera
if (!$_SESSION['idioma' ] OR !  ($_SESSION['idioma' ] == 2 ) )
{
    $shop="Tienda";
...
if (!isset($_SESSION['idioma' ]) OR !($_SESSION['idioma' ] == 2) ) {
...
if (!  ($_SESSION['idioma' ] == 2 ) ) {
    $wellcome="<br><br><br>Bienvenidos a la tienda";
...
//Paises
if( isset($_SESSION['idioma']) && $_SESSION['idioma'] == 2 ) {
    ...
    if ( isset($_SESSION['valid_user']) && $_SESSION['valid_user']['country'] == 1)
        $country_value="Espa�a";
    elseif ($_SESSION['valid_user']['country'] == 2)
        $country_value="Alemania";
    elseif ($_SESSION['valid_user']['country'] == 3)
        $country_value="Suecia";
    elseif ($_SESSION['valid_user']['country'] == 4)
        $country_value="Portugal";
    elseif ($_SESSION['valid_user']['country'] == 5)
        $country_value="Suiza";
    elseif ($_SESSION['valid_user']['country'] == 6)
        $country_value="Francia";
    elseif ($_SESSION['valid_user']['country'] == 7)
        $country_value="Italia";
    elseif ($_SESSION['valid_user']['country'] == 8)
        $country_value="Holanda";
    elseif ($_SESSION['valid_user']['country'] == 9)
        $country_value="Belgica";
    elseif ($_SESSION['valid_user']['country'] == 10)
        $country_value="Andorra";
    elseif ($_SESSION['valid_user']['country'] == 11)
        $country_value="Dinamarca";
    elseif ($_SESSION['valid_user']['country'] == 12)
        $country_value="Grecia";
    elseif ($_SESSION['valid_user']['country'] == 13)
        $country_value="Austria";
