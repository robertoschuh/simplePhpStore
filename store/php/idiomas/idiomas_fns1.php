...
//Variables idiomas en caso de ser español o cualquiera menos inglés 
if (!  ($_SESSION['idioma' ] == 2 ) )
{
...
$confirm_mail_pwd_rescue="<br><br><br>Escriba su mail dos veces, se le enviará en breve un Email con un enlace donde podrá asignar a su cuenta una nueva contraseña";
$no_more_promo="No deseo recibir más ofertas a mi Email";
...
$no_articles="<br><br><br>Sorry at the moment no articles in this categorie";
	...
	{	
	 ...
	 if($_SESSION['idioma']==2)
		...
		$textito_cesta="<b>Bienvenido: aquí puede:</b> <br><br> · Conocer el estado de su cesta de la compra. <br> · Modificar las cantidades de cada producto. Para
 ello introduzca el número de unidades que desea y
...
$ok_message="<div class='message' align='center'><br><br><br><br><br><br><br><b>Proceso terminado, su pedido se ha realizado correctamente.</b><br>
			...
			/*		  $ok_message="<div class='message' align='center'><br><br><br><br><br><br><br><b>Proceso terminado, provisionalmente por razones de mantenimiento no podemos atender su pedido por la web, por ello le pedimos se ponga en contacto con nosotros por teléfono , Gracias: <h3>955904274</h3<h3>615623896</h3></b><br>";*/
...
//TEXTOS MAILS  envio pedido , restauración contraseña etc etc
