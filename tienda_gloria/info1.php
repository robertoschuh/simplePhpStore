...
La información a continuación detallada se refiere a compras realizadas dentro del territorio nacional, para compras internacionales póngase en contacto con nosotros a través de nuestra dirección de correo electrónico.

Las miniaturas y belenes ofrecidos en nuestra web están elaborados artesanalmente por lo que las medidas que se especifican son de carácter orientativo. Así, nuestros artículos pueden presentar ligeras variaciones en cuanto a sus dimensiones y tonalidades, realizadas en algunos casos a propósito con el fin de que adquieran una apariencia más realista. Le sugerimos que nos indique en comentarios el tamaño de sus figuras.

Las compras realizadas en www.gloriabotonero.com, están sometidas a la normativa vigente y se entiende que las operaciones de venta están hechas en el domicilio de la empresa de: </p></td>
        </tr>
      </table>
      ...
      <table width="700" border="0" cellspacing="9" cellpadding="9">
        <tr bgcolor="#FFFFFF">
          <td><ul>
            <li>Entre en la categoría deseada a través de la barra que aparece a la izquierda, seleccione los artículos deseados y añádalos a la cesta de la compra.</li>
            <li>Si es la primera vez que realiza un pedido, deberá registrarse como cliente una vez finalizada la compra.
			</li>
            <li>Si por el contrario ya es usuario registrado, introduzca su clave de usuario y aparecerán sus datos, confirme que son correctos y seleccione la forma de pago.</li>
            <li>Una vez realizado el pedido, recibirá un e-mail con los detalles de su compra. Deberá responder a este e-mail confirmando su pedido si desea recibir la mercancía.  </li>
            <li>Le recomendamos revisar su bandeja de Spam para evitar que nuestros e-mails entren como correo no deseado.           </li>
            <li> No efectúe ningún pago hasta recibir nuestra confirmación.  </li>
          </ul></td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p class="style5">Envío del pedido    </p>
      <table width="700" border="0" cellspacing="9" cellpadding="9">
        <tr bgcolor="#FFFFFF">
          <td><ul>
        ...
        <tr bgcolor="#FFFFFF">
          <td><p align="left" class="style9">Puede elegir entre dos modalidades de pago:</p>
            <p align="left" class="style7"> - Contra reembolso a la entrega de la mercanc&iacute;a.<br>
              - Ingreso o transferencia bancaria a la siguiente cuenta de La Caixa: 
              CCC   2100-1828-82-0100111029</p>
            <p align="left" class="style9"> Para transferencias desde el extranjero necesitar&aacute; los c&oacute;digos BIC e IBAN:</p>
            <p align="left" class="style9"> IBAN  ES42 2100  1828  8201  0011  1029 <br>
            BIC/CODIGO  SWIFT,  CAIXESBBXXX</p>
			...
			Si usted elige el pago contra reembolso, la forma de envío también será contra reembolso.</p>
            <p align="left" class="style9">Si elige el pago a través de ingreso o transferencia en cuenta bancaria, el envío será a través de la agencia Tourline Express. En ambos casos, los gastos de envío corren por cuenta del cliente. 
			 </p>
      ...
      <table width="700" border="0" cellspacing="9" cellpadding="9">
        <tr bgcolor="#FFFFFF">
          ...
          <p align="justify" class="style9">Si desea realizar una devoluci&oacute;n por alg&uacute;n motivo diferente al defecto de f&aacute;brica, se lo cambiaremos por otro art&iacute;culo o por un abono para su pr&oacute;xima compra. En este caso los portes tambi&eacute;n correr&aacute;n por cuenta del cliente y el art&iacute;culo o los art&iacute;culos en cuesti&oacute;n deber&aacute;n estar en perfecto estado, con su embalaje original y acompa&ntilde;ados de la factura de compra. Dispondr&aacute; de 15 d&iacute;as para comunic&aacute;rnoslo. </p></td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <p class="style5">Protecci&oacute;n de datos </p>
      <table width="700" border="0" cellspacing="9" cellpadding="9">
        <tr bgcolor="#FFFFFF">
          <td><div align="justify">En cumplimiento de lo dispuesto en el art&iacute;culo 5 de la Ley Org&aacute;nica 15/1999, del 13 de diciembre, de Protecci&oacute;n de Datos de Car&aacute;cter Personal (LOPD), la firma Gloria Botonero se compromete a tratar de forma absolutamente confidencial todos los datos de car&aacute;cter personal y a utilizarlos s&oacute;lo a efectos de tr&aacute;mite de pedidos, informaci&oacute;n sobre ofertas y novedades, sin ser cedidos en ning&uacute;n caso a terceros. </div></td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <p class="style5">Encargos y consultas</p>
      <table width="700" border="0" cellspacing="9" cellpadding="9">
        <tr bgcolor="#FFFFFF">
          <td>Para venta a tiendas, encargos especiales de miniaturas o artículos para belenes y cualquier otra consulta que desee realizar, llámenos al (+34) 955904274, o bien escríbanos a la siguiente dirección de correo electrónico: info@gloriabotonero.com </td>
        </tr>
      </table>      <p>&nbsp;</p></td>
  </tr>
</table>
