...
//asi el inglés sería obligatorio
...
$img_id= last_id($artid); /*Esto nos sirve para obtener la última id de artid ,nos sirve tanto para loas imagnes como para el almacen*/

//Añadimos el número de unidades de este artículo a el almacen
$almacen=add_unidades($img_id,$unidades);			
															
if (!$almacen)
{
echo "Ha habido problema mientras se llenaba el almacen de existencias de este artículo,<br> probablemente esa referencia ya exista sino consulte con su soporte técnico,Gracias<br><br><a href='javascript:history.back(1)' class='volver'>Volver</a>";
...
echo "No se ha podido almacenar este artículo, porfavor inténtelo mas tarde, Gracias<br>";
...
else
{
	echo "Artículo añadido a la base da datos, Gracias";
 	echo " <a href='javascript:history.back(-1)'>Añadir Otro</a><br>";

}

//esta función esta tambien en admin_fns.php
