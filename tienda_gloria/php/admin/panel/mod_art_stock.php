...
echo "Su Art?culo se ha actualizado correctamente, Gracias.";

else

echo "No se ha podido llevar a cabo la actualizaci?n , porfavor int?ntelo de nuevo y sino puede consulte a su soporte t?cnico, Gracias";

//Volvemos a nombrar la nueva imagen con un nuevo nombre ,que ser? el artid +art+ su extensi?n.
