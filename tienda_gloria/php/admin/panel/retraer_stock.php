...
if ($_GET['question']==1)
{
//Listamos todos las Ids de artículos y sus unidades para descontarlas del stock
	...
	$result =mysql_query( "update almacen
		...
		echo "<center>Artículo con<b> Id: $key</b> Descontado <b> $value Unidades </b> del stocaje<br></center>";
	 	...
	 	if (!$result)
			...
			echo "<center><h5>Artículos correctamente descontados del stock:<br></h5></center>";
