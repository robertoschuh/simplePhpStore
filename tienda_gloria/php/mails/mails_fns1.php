...
$envio_modo="y envío por Tourline Express";
}
else
{
$pago="Contrarembolso";
...
<p>En breve nos pondremos en contacto con Vd. para darle la información detallada de su compra.<p>
<p>No realice ningún pago ahora.</p>
<p>Sus datos son los siguientes:</p>
<p><b>Pedido número $ref </b>de fecha ". $date."</p>
